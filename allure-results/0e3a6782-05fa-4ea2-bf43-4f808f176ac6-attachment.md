...
Locator: locator('.oxd-table-card').filter({ hasText: '2026-14-09 to 2026-15-09' }).filter({ hasText: 'CAN - Bereavement' }).filter({ hasText: 'Pending Approval' }).first()
Expected: visible
Timeout: 15000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('.oxd-table-card').filter({ hasText: '2026-14-09 to 2026-15-09' }).filter({ hasText: 'CAN - Bereavement' }).filter({ hasText: 'Pending Approval' }).first() with timeout 15000ms
  - waiting for locator('.oxd-table-card').filter({ hasText: '2026-14-09 to 2026-15-09' }).filter({ hasText: 'CAN - Bereavement' }).filter({ hasText: 'Pending Approval' }).first()
...
```ts
  ...
  12 | 
  13 |    const fromDate = '2026-14-09';
  14 | const toDate = '2026-15-09';
